...
const DiagnosticosPorEmpleados = ({ empleados, total_diagnosticos }) => {
  const data = {
    ...
    datasets: [
      {
        ...
        backgroundColor: 'rgba(192, 189, 0, 0.75)',
        borderColor: 'rgba(126, 245, 29, 0.5)',
        borderWidth: 2,
      },
    ],
  };
  ...
  const generarPDF = () => {
    ...
    const nombreArchivo = `DiagnósticosporEmpleado_${dia}_${mes}_${anio}.pdf`;
...
return (
  <Card style={{ height: "100%" }}>
    <Card.Body>
      <Card.Title>Diagnósticos por Empleados </Card.Title>
...
export default DiagnosticosPorEmpleados;